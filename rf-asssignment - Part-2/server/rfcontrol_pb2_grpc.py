...
class RFServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetRFSettings = channel.unary_unary(
                '/rfcontrol.RFService/SetRFSettings',
...
class RFServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RFServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'rfcontrol.RFService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('rfcontrol.RFService', rpc_method_handlers)
